...
string.length - 1. In other words, a two-character string has length2, and its characters 
...
uppercase "B" characters). Rewrite countBs to make us of this new function. */ 
